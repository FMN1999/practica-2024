...
def numeros_al_final_comprension(lista: List[Union[float, str]]) -> List[Union[float, str]]:
    ...
    cadenas = [i for i in lista if isinstance(i, str)]
    enteros = [i for i in lista if isinstance(i, int)]
    return cadenas + enteros
...
def numeros_al_final_filter(lista: List[Union[float, str]]) -> List[Union[float, str]]:
    ...
    """
    cadenas = list(filter(lambda x: isinstance(x, str), lista))
...
def numeros_al_final_recursivo(lista: List[Union[float, str]]) -> List[Union[float, str]]:
    ...
    if all(type(i) is not str for i in lista):
        return lista
